...
const saved = localStorage.getItem('stripe4Progress');
if (saved) {
...
localStorage.setItem('stripe4Progress', JSON.stringify(data));
}
...
localStorage.setItem('completedStripes', JSON.stringify(completedStripes));
        ...
        // Clear progress
localStorage.removeItem('stripe4Progress');
        // Show continue button
setTimeout(() => {
if (confirm('🎉 White Belt Complete!\n\nReady for the White Belt Assessment?')) {
window.location.href = 'white-belt-assessment.html';
} else {
