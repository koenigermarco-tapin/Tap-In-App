-- TAP-IN Clean Database Setup
-- This DROPS existing functions and recreates everything from scratch
...
-- Now drop functions
DROP FUNCTION IF EXISTS add_xp(UUID, INTEGER, VARCHAR, TEXT);
DROP FUNCTION IF EXISTS update_streak(UUID);
DROP FUNCTION IF EXISTS add_badge(UUID, VARCHAR);
DROP FUNCTION IF EXISTS complete_assessment(UUID, VARCHAR, INTEGER);
...
-- ============================================================================
-- STEP 3: Create XP History table
-- ============================================================================
...
-- ============================================================================
-- STEP 4: Create Assessment Results table
-- ============================================================================
...
-- ============================================================================
-- STEP 6: Function to Add XP
-- ============================================================================

CREATE FUNCTION add_xp(
    p_user_id UUID,
    p_amount INTEGER,
...
-- ============================================================================
-- STEP 7: Function to Update Streak
-- ============================================================================
...
-- ============================================================================
-- STEP 8: Function to Add Badge
-- ============================================================================

CREATE FUNCTION add_badge(p_user_id UUID, p_badge VARCHAR(100))
RETURNS JSON AS $$
DECLARE
    v_badges TEXT[];
...
-- ============================================================================
-- STEP 9: Function to Complete Assessment
-- ============================================================================

CREATE FUNCTION complete_assessment(
    p_user_id UUID,
...
-- ============================================================================
-- STEP 10: Trigger to Auto-Create Profile on User Signup
-- ============================================================================
...
-- You should now have:
-- ✓ 3 tables (user_profiles, xp_history, assessment_results)
...
-- Next step: Deploy your app to Netlify!
