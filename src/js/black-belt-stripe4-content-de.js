// ===== BLACK BELT STRIPE 4: NACHHALTIGE EXZELLENZ (GERMAN) =====
const allChunks = [
    {
        lessonNumber: "Lektion 1 von 4",
        lessonTitle: "Langfristige Performance",
        content: `<div class="content-section">
    <h3>🎯 Was Sie lernen werden</h3>
    <p>Dieser Abschnitt konzentriert sich auf nachhaltige exzellenz Prinzipien und Praktiken.</p>
</div>`,
        question: {
    ...
    },
    {
        ...
        lessonTitle: "Kontinuierliche Verbesserung",
        content: `<div class="content-section">
    <h3>🎯 Was Sie lernen werden</h3>
    <p>Dieser Abschnitt konzentriert sich auf nachhaltige exzellenz Prinzipien und Praktiken.</p>
</div>`,
