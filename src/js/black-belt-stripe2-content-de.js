// ===== BLACK BELT STRIPE 2: KOLLEKTIVE ZIELE (GERMAN) =====
const allChunks = [
    {
        lessonNumber: "Lektion 1 von 4",
        lessonTitle: "Team-Ziele setzen",
        content: `<div class="content-section">
    <h3>🎯 Was Sie lernen werden</h3>
    <p>Dieser Abschnitt konzentriert sich auf kollektive ziele Prinzipien und Praktiken.</p>
</div>`,
        question: {
    ...
    },
    {
        ...
        lessonTitle: "Individuelle und Team-Ziele ausrichten",
        content: `<div class="content-section">
    <h3>🎯 Was Sie lernen werden</h3>
    <p>Dieser Abschnitt konzentriert sich auf kollektive ziele Prinzipien und Praktiken.</p>
</div>`,
    ...
    },
    {
        ...
        lessonTitle: "Gemeinsame Erfolgsmetriken",
        content: `<div class="content-section">
    <h3>🎯 Was Sie lernen werden</h3>
    <p>Dieser Abschnitt konzentriert sich auf kollektive ziele Prinzipien und Praktiken.</p>
</div>`,
