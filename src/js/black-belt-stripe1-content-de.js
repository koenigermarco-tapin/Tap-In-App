// ===== BLACK BELT STRIPE 1: ERGEBNIS-FOKUS (GERMAN) =====
const allChunks = [
    {
        lessonNumber: "Lektion 1 von 4",
        lessonTitle: "Kollektive vs. individuelle Ergebnisse",
        content: `<div class="content-section">
    <h3>🎯 Was Sie lernen werden</h3>
    <p>Dieser Abschnitt konzentriert sich auf ergebnis-fokus Prinzipien und Praktiken.</p>
</div>`,
        question: {
    ...
    },
    {
        ...
        lessonTitle: "Ergebnisorientierung",
        content: `<div class="content-section">
    <h3>🎯 Was Sie lernen werden</h3>
    <p>Dieser Abschnitt konzentriert sich auf ergebnis-fokus Prinzipien und Praktiken.</p>
</div>`,
    ...
    },
    {
        ...
        lessonTitle: "Performance Kultur",
        content: `<div class="content-section">
    <h3>🎯 Was Sie lernen werden</h3>
    <p>Dieser Abschnitt konzentriert sich auf ergebnis-fokus Prinzipien und Praktiken.</p>
</div>`,
